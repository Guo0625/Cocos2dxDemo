...
var wb = window.wb || {};
wb.XmlHelper = wb.XmlHelper || {};
if (typeof(XML) == 'undefined') XML = function () {
};
wb.XmlHelper.XML = XML;
//  constructor
...
wb.XmlHelper.parse = function (str) {
    if (!wb.XmlHelper.xotree) wb.XmlHelper.xotree = new XML.ObjTree();
    return wb.XmlHelper.xotree.parseXML(str);
};